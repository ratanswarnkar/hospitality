                                        ...
                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                            <div class="hot-page2-alp-r-list">
                                                <div class="col-md-4 hot-page2-alp-r-list-re-sp">
                                                    <!--link of image-->
                                                    <a href="../india-special-tour/dharavi-slum-tour.html">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                                            <div class="hot-page2-alp-ri-p3 tour-alp-ri-p3">
                                                                ...
                                                                <!-- detial page link-->
                                                                <a href="../india-special-tour/dharavi-slum-tour.html" class="hot-page2-alp-quot-btn">View Details</a>
...
<!--enquiry link-->
<a href="#" onclick="doEnquiry('dharavi-slum-tour'); return false;" class="hot-page2-alp-quot-btn">Enquiry Now</a>
</span></div>
                                                        </div>
                                                    </div>
                                                </div>
