                ...
                <div class="common-content">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                            ...
                            <!--package name-->
                            <h3>Bollywood Tours</h3>

                            <!--overview-->
                            <p class="overview">The centre of India's booming Bollywood Mumbai welcomes you to explore the fun city thoroughly. Get mesmerised by the number of studios and filmstars walking on the same aisle. Over 100 films are produced every year there.
                                It's amazing to take a Bollywood tour to the heart of the action in Film City. </p>
                    ...
                    <form name="enqForm" action="../enquiry.php" method="POST">
                        <input type="hidden" name="httprefrer" value="https://www.b2bhospitalityindia.com/india-special-tour/bollywood-tours.html">
                                                ...
                                                <div class="col-md-4 hot-page2-alp-r-list-re-sp">
                                                    ...
                                                    <a href="{{ asset('bollywood-tour-details') }}">
                                                        ...
                                                        <div class="hot-page2-hli-1">
                                                            ...
                                                            <!--image path-->
                                                            <img src="../images/tourintro/bollywood-tour-packages.jpg" alt="Bollywood Tour"> </div>
